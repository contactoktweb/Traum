...
export default function GraciasPage() {
  ...
  return (
    <main className="relative h-[100dvh] w-screen overflow-hidden bg-[#FAF6EE]">
      ...
      {/* Hero */}
      <section
        className="relative h-[100dvh] w-full flex items-center justify-center overflow-hidden bg-[position:bottom_center] md:bg-[position:center] bg-[url('/fondo-acabado-mobile.png')] md:bg-[url('/fondo-acabado.png')]"
        style={{
      ...
      >
        {/* Main content */}
        <div className="relative z-10 w-full max-w-7xl mx-auto px-4 md:px-12 flex flex-col items-center text-center pb-8 md:pb-16 pt-16 md:pt-0">
          {/* Eyebrow */}
          <div
          ...
          <div className="flex flex-col items-center gap-y-4 w-full">
            {/* Main title */}
            <h1 className="overflow-visible shrink-0 flex justify-center w-full flex-wrap gap-x-2 md:gap-x-4 py-4">
              {"GRACIAS".split("").map((char, i) => (
                <span
                  key={i}
            ...
            {/* Subtitle */}
            <div 
              className="gracias-text text-lg md:text-2xl lg:text-3xl font-bold mt-8 max-w-2xl text-center"
              style={{
                opacity: isLoaded ? 1 : 0,
                transform: isLoaded ? "translateY(0)" : "translateY(20px)",
