...
.cart-overlay {
    ...
    z-index: 1010; transition: opacity 0.5s ease-in-out;
}
...
/* Fade in/out classes synced with the overlay */
.machine-wrapper.visible { opacity: 1; }
.machine-wrapper.hidden { opacity: 0; }
...
.receipt-logo { display: flex; justify-content: center; position: relative; margin-bottom: 20px; color: #213023; }
.receipt-logo span { letter-spacing: -2px; color: #9CA3AF; font-weight: normal; margin-top: 8px; }
.logo-image { position: absolute; top: 0; left: 50%; transform: translateX(-50%); width: 100px; height: 35px; opacity: 0.9; mix-blend-mode: multiply; }
  ...
  return (
    <>
      ...
      <div className="cart-container">
        <div className={`machine-wrapper ${isCartOpen ? 'visible' : 'hidden'}`}>
