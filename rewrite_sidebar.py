        ...
        <div className="cart-machine">
            ...
            <div className="receipt-wrapper">
                ...
                <div id="receipt" className={`paper-bg sawtooth ${animClass}`}>
                    ...
                    <div className="cart-items">
                      {cartItems.length === 0 ? (
                        <div className="empty-cart flex flex-col items-center gap-2">
                           <svg className="w-8 h-8 text-gray-400 mx-auto opacity-50" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z"></path></svg>
                           <p>Tu carrito está vacío</p>
                           <button onClick={handleClose} className="mt-4 px-4 py-2 bg-black text-white text-xs font-bold uppercase rounded hover:bg-gray-800 transition-colors">Volver a la tienda</button>
                        </div>
                      ) : (
                        cartItems.map((item) => (
                    ...
                    <div className="dash-line mb-4"></div>
